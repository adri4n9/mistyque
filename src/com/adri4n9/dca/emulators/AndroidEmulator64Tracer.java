...
public class AndroidEmulator64Tracer extends AndroidARM64Emulator implements DCATracer {

    protected AndroidEmulator64Tracer(String processName, File rootDir, Collection<BackendFactory> backendFactories) {
     ...
     * @param listener defines a listener to perform a custom function  to be called when the hook is called
     * @return TraceHook reference to the hook
     */
    public TraceHook traceCode(long begin, long end, TraceCodeListener listener) {
        //System.out.println("tracecode callx");
     ...
     *  begin < end
     *  if a trace of the entire space is needed, use the following values
     *  begin ==1
     *  end == 0
