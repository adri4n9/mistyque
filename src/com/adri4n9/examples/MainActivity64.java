...
public class MainActivity64 {
    ...
    public MainActivity64() {

        //default implementation I will try to override the default tracer without touching the framework to maximise portability
         //emulator = AndroidEmulatorBuilder.for32Bit()
         //               .setProcessName("com.adri4n9.wbctestapplication")
         //               .build();

        //set up the emulator  on this case a 64 bit emulator.
        // I do not think the process name matters that much. I would advise to  use the same as the application package
        emulator = AndroidTraceEmulatorBuilder.for64Bit()
                .setProcessName("com.adri4n9.WBCexample")
                .build();
        ...
        DalvikModule dm = vm.loadLibrary(new File("mystique/WBCTargets/CHOW/arm64-v8a/libWBCexample.so"), false);
    ...
    public static void main(String[] args) throws Exception {
        ...
        MainActivity64 main = new MainActivity64();
        main.run(1);
        main.destroy();
    }
